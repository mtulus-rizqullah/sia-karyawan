    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <p>Pilih tabel dibawa ini, lalu silahkan isi Form dibawah ini untuk melakukan perubahan</p>
                ...
                <?php
                    header("refresh:5;url=update.php");//5 : detik
                }
                ?>
                <?php
                if ($sukses) {
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="update.php?op=edit&id=<?php echo $id ?>">Edit</button></a>
                                    <a href="update.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau delete data?')">Delete</button></a>            
                                </td>
                            </tr>
                        <?php
                        }
